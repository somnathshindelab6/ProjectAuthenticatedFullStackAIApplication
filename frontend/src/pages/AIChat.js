    ...
    <div className='space-y-6'>
      ...
      <div className='rounded-3xl bg-white p-6 shadow-sm'>
        ...
        <form onSubmit={submit} className='space-y-4'>
          <textarea rows={6} value={query} onChange={e => setQuery(e.target.value)} className='w-full rounded-3xl border border-slate-200 bg-slate-50 px-4 py-4 text-slate-900 focus:border-sky-500 focus:outline-none' placeholder='Ask the AI how to prioritize tasks, finish work faster, or plan your day.' />
          <button className='rounded-2xl bg-sky-600 px-6 py-3 text-white font-semibold hover:bg-sky-700 transition'>Ask AI</button>
        </form>
      </div>
